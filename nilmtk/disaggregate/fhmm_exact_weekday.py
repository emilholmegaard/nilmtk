...
from ..preprocessing import Apply, Clip, SelectByDay
...
class FHMM_Weekday(object):

    def __init__(self, useWeekend=False):
        self.useWeekend = useWeekend
        self.model = {}
    ...
    def train(self, metergroup, **load_kwargs):
        ...
        """
        if self.useWeekend:
            load_kwargs['preprocessing']=[SelectByDay(day='weekend')]
        else:
            load_kwargs['preprocessing']=[SelectByDay()]
